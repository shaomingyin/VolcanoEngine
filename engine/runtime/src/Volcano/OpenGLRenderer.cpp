...
const QSize &OpenGLRenderer::size(void)
{
    return m_size;
}

void OpenGLRenderer::resize(const QSize &v)
{
    if (m_size == v)
        return;
...
void OpenGLRenderer::updateGBuffer(void)
{
    Q_ASSERT(m_gl != nullptr);
...
void OpenGLRenderer::releaseGBuffer(void)
{
