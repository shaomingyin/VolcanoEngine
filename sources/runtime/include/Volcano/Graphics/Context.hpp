...
public:
    ...
    QOpenGLShaderProgram &builtinShader(int id);
...
private:
    bool init(void);
    bool setupShader(QOpenGLShaderProgram &out, const char *vs, const char *fs);
...
private:
    ...
    QOpenGLShaderProgram m_builtinShaders[BUILTIN_SHADER_MAX];
};
