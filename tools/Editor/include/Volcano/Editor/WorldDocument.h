//
//
#ifndef VOLCANO_EDITOR_WORLDDOCUMENT_H
#define VOLCANO_EDITOR_WORLDDOCUMENT_H
...
class WorldDocument: public Core::IDocument {
    Q_OBJECT

public:
    WorldDocument(QObject* parent = nullptr);
...
#endif // VOLCANO_EDITOR_WORLDDOCUMENT_H
