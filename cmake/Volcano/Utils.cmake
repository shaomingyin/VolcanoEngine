...
macro(volcano_add_shared_library TARGET)
	...
	string(MAKE_C_IDENTIFIER ${TARGET} TARGET_ID)
	string(TOUPPER ${TARGET_ID} TARGET_ID_UPPER)
	target_compile_definitions(${TARGET} PRIVATE "VOLCANO_${TARGET_ID_UPPER}_EXPORTS")
	set(VOLCANO_${TARGET_ID_UPPER}_SHARED ON)
    volcano_setup_target(${TARGET} ${ARGN})
    if(MSVC)
