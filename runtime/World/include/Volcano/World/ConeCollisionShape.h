//
//
#ifndef VOLCANO_WORLD_CONECOLLISIONSHAPE_H
#define VOLCANO_WORLD_CONECOLLISIONSHAPE_H
...
public:
    ConeCollisionShape(QObject* parent = nullptr);
...
#endif // VOLCANO_WORLD_CONECOLLISIONSHAPE_H
